...
Turtle.step = function(command, values) {
  ...
  switch (command) {
    case 'FD':  // Forward
      ...
      carMove='http://192.168.8.1/cgi-bin/g?value=' + Math.floor(distance/15);
    ...
    case 'RT':  // Right Turn
      ...
      var argle = values[0];
      argle %= 360;
      carMove='http://192.168.8.1/cgi-bin/t?value=' + Math.floor((argle>180?argle-360:argle)/18);
      //carMove='http://192.168.8.1/cgi-bin/t?value=33';
	  //carWait=1500;
      break;
    case 'DP':  // Draw Print
